...
const htmlQuestions = [
  ...
  {
    question: "Which of these elements don't require a closing tag?",
    answers: ['img', 'h1', 'a', 'p'],
    correctAnswer: 'img',
  },
  {
    question: 'In HTML5 the break tag requires a closing tag.',
    answers: ['false', 'true'],
    correctAnswer: 'false',
  },
  {
    question: 'How many types of CSS can be included in HTML?',
    answers: ['4', '2', '3'],
    correctAnswer: '3',
  },
  {
  ...
  {
    question:
      'Where in my HTML code would I place a line that determines the size of the viewport?',
  ...
  {
    question:
      'Which of the tags is the grandparent of tag <strong> in this expression? <div><span><strong></strong></span></div>?',
...
const cssQuestions = [
  ...
  {
    question: 'Which of these specificity will take precedence over others?',
    answers: ['h1.red', 'h1#yellow', 'h1'],
    correctAnswer: 'h1#yellow',
  },
  {
    question: 'Dot (.) is to id while hash (#) is to class. This statement is?',
    answers: ['correct', 'wrong'],
    correctAnswer: 'wrong',
  },
  {
    question: 'Internal css does not require the <style> tag in HTML 5.',
    answers: ['true', 'false'],
    correctAnswer: 'false',
  },
  {
    question: '______ is used to select an html tag with an id in css.',
    answers: ['/', '.', '#', '#/'],
    correctAnswer: '#',
  },
  {
  ...
  {
    question: 'Which of these color values is not valid?',
  ...
  },
  {
    ...
    answers: ['font: bold;', 'font-weight: bold;', 'style: bold;'],
...
const javascriptQuestions = [
  ...
  },
  {
    ...
    answers: [
      'no error occurs',
      'destructured variables are also undefined',
...
const sqlQuestions = [
  {
    ...
    answers: [
      ...
      'Simple Query linguistic',
    ],
    correctAnswer: 'Structured Query Language',
  },
  {
    question: 'Are SQL keywords case sensitive? e.g select vs SELECT',
    answers: ['Yes', 'No'],
    correctAnswer: 'No',
  },
  {
